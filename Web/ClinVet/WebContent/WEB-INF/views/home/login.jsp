...
<div class="container">
	<div class="form-container flip">
		<form class="login-form" action="/squallsoft-clinvet/login" method="post"
				modelAttribute="usuario" >
			<h3 class="title">Login.</h3>
			<div class="row">
				<div class="col-md-3">
					<div class="form-group" id="username" align="center">
						<input class="form-input" tooltip-class="username-tooltip"
							placeholder="Nome de usuario" name="username" required="true"></input> <span
							id="username-tool" class="tooltip username-tooltip">Qual é o seu nome?</span>

						<div class="form-group" id="password">
							<input type="password" class="form-input"
								tooltip-class="password-tooltip" name="password" placeholder="Password"></input>
							<span class="tooltip password-tooltip">Entre com sua senha.</span>
						</div>
					</div>
				</div>
			</div>
