...
<c:url var="actionAdicionar" value="/home/admin"></c:url>

	<form:form action="${actionAdicionar}" method="post"
		modelAttribute="usuario">
		<div class="form-container flip">
			<form class="login-form">
				<h3 class="title">Cadastro de administrador</h3>
				<div class="form-group" id="username">
					<div>
						<input name="username" class="form-input"
							tooltip-class="username-tooltip" placeholder="Seu nome"></input>
						<span class="tooltip username-tooltip">Qual é seu nome?</span>
					</div>
				...
				<div class="form-group">
					<div>
						<input name="password" type="password" class="form-input"
							tooltip-class="password-tooltip" placeholder="Sua senha"></input>
						<span class="tooltip password-tooltip">Qual é seu password?</span>
